...
function init() {
    ...
    for(var i=0; i<opciones.length; i++){
        switch(i){
            ...
            resultado.innerHTML = "<p class=\"letterpress\">" +"los metros "+ op1 + " = " + (op1 * 3.28 ) +"pies"+ "</p>\n";
            }
            break;
            case 1:
            opciones[i].onclick = function(){
            resultado.innerHTML = "<p class=\"letterpress\">"+"los metros" + op1 + "  = " + (op1 * 39.37) +"pulgadas"+ "</p>\n";
            }
            break;
            case 2:
            opciones[i].onclick = function(){
            resultado.innerHTML = "<p class=\"letterpress\">"+"los metros" + op1 + " = " + (op1 * 1.094) +"yardas"+ "</p>\n";
            }
            break;
            case 3:
            opciones[i].onclick = function(){
            if(op1 == 0){
            resultado.innerHTML = "<p class=\"letterpress\">No se puede por cero</p>";
            }
            else {
